        ...
        <div className="space-y-2">
            ...
            {type === 'textarea' ? (
                <textarea
                    ...
                    rows={rows}
                    disabled={isLoading}
                    className={`w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all resize-none ${isLoading ? 'bg-gray-100 cursor-not-allowed' : ''}`}
                ...
                <select
                    ...
                    required={required}
                    disabled={isLoading}
                    className={`w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all ${isLoading ? 'bg-gray-100 cursor-not-allowed' : ''}`}
                >
                ...
                <div className="overflow-y-auto w-3/5 bg-white flex items-center justify-center p-8">
                    <div className="w-full max-w-2xl">
                        <div className="mb-8">
                            ...
                            <p className="text-gray-600">Tell us about your startup journey</p>
                        </div>
                            ...
                            <div className="flex gap-4 pt-6">
                                ...
                                {currentStep < totalSteps ? (
                                    <button
                                        ...
                                        className={`flex-1 py-3 px-6 rounded-xl font-semibold transition-all duration-200 shadow-lg flex items-center justify-center gap-2 ${isLoading || !isStepValid(currentStep)
                                    ...
                                    <button
                                        type="submit"
                                        disabled={isLoading || !isStepValid(currentStep)}
                                        className={`flex-1 py-3 px-6 rounded-xl font-semibold transition-all duration-200 shadow-lg ${isLoading || !isStepValid(currentStep)
                                            ? 'bg-gray-400 cursor-not-allowed'
                            ...
                            <div className="flex gap-3 pt-4">
                                ...
                                {currentStep < totalSteps ? (
                                    <button
                                        ...
                                        onClick={nextStep}
                                        disabled={isLoading || !isStepValid(currentStep)}
                                        className={`flex-1 py-3 px-4 rounded-xl font-semibold transition-all flex items-center justify-center gap-2 ${isLoading || !isStepValid(currentStep)
                                            ? 'bg-gray-400 cursor-not-allowed'
                                    ...
                                    <button
                                        type="submit"
                                        disabled={isLoading || !isStepValid(currentStep)}
                                        className={`flex-1 py-3 px-4 rounded-xl font-semibold transition-all ${isLoading || !isStepValid(currentStep)
                                            ? 'bg-gray-400 cursor-not-allowed'
